...
from spyne import Application, rpc, ServiceBase, Integer, Iterable, Unicode, Float
...
class NearChargingStations(ServiceBase):
    @rpc(Float, Float, Integer, _returns=Iterable(Unicode))
...
application = Application(
    [ComputeTravelTime, NearChargingStations],            # Liste des services exposés
